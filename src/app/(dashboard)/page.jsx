...
const Page = () => {
  ...
  const [stats, setStats] = useState({ totalDeals: 0, activeDeals: 0, fulfilledDeals: 0 });
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 my-6">
        <div className="w-full border border-[#F0F0F0] rounded-sm p-5">
          <h2 className="text-xl font-semibold text-[#444444]">Total Deals</h2>
          <h2 className="text-3xl font-semibold text-[#262626] mt-3.5">{loadingStats ? "..." : stats.totalDeals}</h2>
        </div>
        <div className="w-full border border-[#F0F0F0] rounded-sm p-5">
          <h2 className="text-xl font-semibold text-[#444444]">Active Deals</h2>
          <h2 className="text-3xl font-semibold text-[#262626] mt-3.5">{loadingStats ? "..." : stats.activeDeals}</h2>
        </div>
        <div className="w-full border border-[#F0F0F0] rounded-sm p-5">
          <h2 className="text-xl font-semibold text-[#444444]">Fulfilled Deals</h2>
          <h2 className="text-3xl font-semibold text-[#262626] mt-3.5">{loadingStats ? "..." : stats.fulfilledDeals}</h2>
        </div>
      </div>
