...
const SoldTable = () => {
  ...
  return (
    <div className="p-1">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-medium text-black">Manage Sold</h3>
      </div>
      <div className="p-4 border rounded-md bg-white">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-[16px] font-semibold text-black">Sold Items</h3>
        ...
        <table className="w-full border border-gray-200 text-sm">
          ...
          <tbody>
            {error ? (
              <tr>
                <td colSpan="5" className="text-red-500 text-center p-4">
                  {error}
                </td>
              </tr>
            ) : loading ? (
              <tr>
                <td colSpan="5" className="text-gray-500 text-center p-4">
                  {/* Show nothing or a spinner here if preferred */}
                </td>
              </tr>
            ) : filteredData.length === 0 ? (
              <tr>
              ...
              filteredData.map((item, index) => (
                <tr key={item.itemId} className="border-t hover:bg-gray-50">
                  ...
                  <td className="py-2 px-6 text-black text-center">
                    {item.itemId}
                  </td>
                  <td className="py-2 px-4 text-black text-center">
                    {item.sold}
