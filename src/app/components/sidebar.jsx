...
// import { Menu, X } from "lucide-react"; // or use emojis if you prefer
...
//             {
//               label: "Manage Deals",
//               icon: "/manage-deals.svg",
//               href: "/deals",
//             },
//             { label: "Manage Buyers", icon: "/manage-buyers.svg" },
//             { label: "Manage Suppliers", icon: "/manage-suppliers.svg" },
//             { label: "Shipping Tracker", icon: "/shipping-tracker.svg" },
...
//       {isOpen && (
//         <div
//           className="fixed inset-0 z-30 bg-opacity-40 md:hidden"
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: "Manage Sold", icon: "/manage-buyers.svg", href: "/sold" },
